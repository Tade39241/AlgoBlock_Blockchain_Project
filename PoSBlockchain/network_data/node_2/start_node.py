...
sys.path.append("/dcs/project/algoblock/MainCode/PoSBlockchain/network_data/node_2")
...
abs_data_dir = "/dcs/project/algoblock/MainCode/PoSBlockchain/network_data/node_2/data"
...
data_dir = os.path.join("/dcs/project/algoblock/MainCode/PoSBlockchain/network_data/node_2", "data")
