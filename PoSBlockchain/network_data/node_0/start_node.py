...
sys.path.append("/dcs/project/algoblock/MainCode/PoSBlockchain/network_data/node_0")
...
abs_data_dir = "/dcs/project/algoblock/MainCode/PoSBlockchain/network_data/node_0/data"
...
data_dir = os.path.join("/dcs/project/algoblock/MainCode/PoSBlockchain/network_data/node_0", "data")
