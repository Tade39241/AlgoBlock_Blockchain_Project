...
sys.path.append("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoSBlockchain/network_data/node_1")

# Store node ID as a variable inside this script
NODE_ID = 1

# Custom database paths - make them absolute paths
blockchain_db_path = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoSBlockchain/network_data/node_1/data", "blockchain.db")
node_db_path = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoSBlockchain/network_data/node_1/data", "node.db")
account_db_path = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoSBlockchain/network_data/node_1/data", "account.db")

# Create data directory if needed
data_dir = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoSBlockchain/network_data/node_1", "data")
...
def simulate_random_transactions(volume, interval=30, tx_types="all"):
    ...
    def transaction_loop():
        ...
        while True:
            ...
            try:
                # --- Add Debugging ---
                print(f"[Sim Debug 14813/{threading.get_ident()}] Creating AccountDB instance...")
                db_instance = AccountDB()
                print(f"[Sim Debug 14813/{threading.get_ident()}] Instance type: {type(db_instance)}")
                if hasattr(db_instance, 'table_name'):
                    print(f"[Sim Debug 14813/{threading.get_ident()}] Instance HAS table_name: '{db_instance.table_name}'")
                else:
                    print(f"[Sim Debug 14813/{threading.get_ident()}] Instance LACKS table_name attribute!")
                # --- End Debugging ---

                print(f"[Sim Debug 14813/{threading.get_ident()}] Calling db_instance.read()...")
                accounts = db_instance.read() # Use the instance we just checked
                print(f"[Sim Debug 14813/{threading.get_ident()}] db_instance.read() completed.")
                ...
                try:
                 ...
                 print(f"[Sim ATTRIBUTE ERROR 14813/{threading.get_ident()}] {ae}")
