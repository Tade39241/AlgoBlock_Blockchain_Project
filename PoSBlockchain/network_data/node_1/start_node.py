    ...
    def transaction_loop():
        ...
        while True:
            try:
                ...
                # # --- Add Debugging ---
                # print(f"[Sim Debug 18086/{threading.get_ident()}] Creating AccountDB instance...")
                # db_instance = AccountDB()
                # print(f"[Sim Debug 18086/{threading.get_ident()}] Instance type: {type(db_instance)}")
                # if hasattr(db_instance, 'table_name'):
                #     print(f"[Sim Debug 18086/{threading.get_ident()}] Instance HAS table_name: '{db_instance.table_name}'")
                # else:
                #     print(f"[Sim Debug 18086/{threading.get_ident()}] Instance LACKS table_name attribute!")
                # # --- End Debugging ---
                ...
                try:
                 ...
                 print(f"[Sim ATTRIBUTE ERROR 18086/{threading.get_ident()}] {ae}")
