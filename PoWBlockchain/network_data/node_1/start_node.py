...
sys.path.append("/dcs/project/algoblock/MainCode/PoWBlockchain/network_data/node_1")
...
data_dir = os.path.join("/dcs/project/algoblock/MainCode/PoWBlockchain/network_data/node_1", "data")
