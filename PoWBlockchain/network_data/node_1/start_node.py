...
blockchain_db_path = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoWBlockchain/network_data/node_1/data", "blockchain.db")
node_db_path = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoWBlockchain/network_data/node_1/data", "node.db")
account_db_path = os.path.join("/Users/tadeatobatele/Documents/UniStuff/CS351 Project/code/PoWBlockchain/network_data/node_1/data", "account.db")
